# -*- coding: utf-8 -*-
"""
Created on Mon Oct 28 16:23:27 2024
...
for block in blocks:
    folderpath = rf'Y:\2021_Bjerke_DevMouse_projects\QuickNII_registration_workspace\P120\{mouseID}\for_deepslice/{block}//'
...
jsonDict = {"name":f"{mouseID}_jointAnchoring_ds","target":"ABA_Mouse_CCFv3_2017_25um.cutlas","target-resolution":[428, 524, 320],"slices":[]}


for block in blocks:
    dsAnchoringJson = rf"Y:\2021_Bjerke_DevMouse_projects\QuickNII_registration_workspace\P120\{mouseID}\for_deepslice/{block}/{block}_ds.json"
...
with open(rf"Y:\2021_Bjerke_DevMouse_projects\QuickNII_registration_workspace\P120\{mouseID}\{mouseID}_jointAnchoring_ds.json", "w") as outfile:
